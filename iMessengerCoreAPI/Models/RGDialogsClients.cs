...
/// <summary>
/// The class designed to store information about which users interact within the same dialog.
/// </summary>
public class RGDialogsClients : IPrimaryKey
{
    /// <summary>
    /// Primary key
    /// </summary>
    ...
    /// <summary>
    /// Get a list of entities with which operations can be performed.
    /// </summary>
    /// <returns>The list of entities with which operations can be performed.</returns>
